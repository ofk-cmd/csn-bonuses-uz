...
<section class="section" id="brand-deep-guide">
  ...
  <p>Если казино и спорт welcome разделены (часто у гибридов БК+казино), выберите направление до регистрации. Позже сменить сложно. У FairPari: казино 20,2 млн UZS + 150 FS или спорт 5,6 млн UZS — один пакет. У {name} может быть похожее правило.</p>
...
<section class="section" id="brand-deep-guide">
  ...
  <p>Agar kazino va sport welcome alohida bo'lsa (ko'p hibrid BK+ kazino larda shunday), ro'yxatdan oldin yo'nalishni tanlang. Keyin o'zgartirish qiyin. FairPari misolida kazino 20,2 mln UZS + 150 FS yoki sport 5,6 mln UZS — bittasini tanlaysiz. {name} uchun ham shunga o'xshash qoida bo'lishi mumkin.</p>
